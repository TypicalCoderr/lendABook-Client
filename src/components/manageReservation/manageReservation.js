...
import ViewReservationModal from "../viewReservation/viewReservationModal";
...
function ManageBookReservations(props) {
  ...
  // console.log(reservation && reservation.books && reservation.books.book);
...
ManageBookReservations.propTypes = {
